...
$(document).ajaxError(function(e, t, n, o) {
        ...
        $("span.noti-unread").each(function() {
            ...
            function t() {
                setTimeout(function() {
                    ...
                    ((new Date).getTime() / 1e3 | 0) - (localStorage.getItem("ln_refresh_time") || 0) < 60 ? t() : (localStorage.setItem("ln_refresh_time", (new Date).getTime() / 1e3 | 0), $.post("/action/notification/fresh", {
                        last: n
                    }, function(n) {
    ...
    if ($("main.search-page div.search-advance").length) {
        ...
        $(".search-advance_toggle").on("click", function() {
            ...
            o += "&" + $(this).serialize(), window.location.href = '/'+ o
        })
    }
}), $(document).ready(function() {
    $(".container").width() <= 768 && $(".gradual-mobile").find("main").hide(), $(".gradual-mobile header").on("click", function() {
        $(this).parent().find("main").toggle(), $(this).find(".mobile-icon i").toggleClass("fa-chevron-down fa-chevron-up")
